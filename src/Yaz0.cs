...
{
    [LibraryImport(CeadLib)] private static partial void Compress(byte* src, int src_len, out PtrHandle dst_handle, out byte* dst, out int dst_len, uint data_alignment, int level);
